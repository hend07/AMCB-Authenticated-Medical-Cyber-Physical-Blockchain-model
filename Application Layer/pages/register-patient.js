...
class RegisterPatient extends Component {
    ...
    onSubmit = async event => {
        ...
        try {
            ...
            // ثانياً: الحفظ في Firebase Firestore
            await setDoc(doc(db, "patients", userAddress), {
                ic, name, phone, gender, dob, height, weight, 
                houseaddr, bloodgroup, allergies, medication, 
                emergencyName, emergencyContact,
                role: 'patient',
                createdAt: new Date()
            });

            alert("Patient record created successfully on Blockchain & Firebase!");
