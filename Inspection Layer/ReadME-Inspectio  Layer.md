...
# 🧩 Application Layer + Storage Layer (AMCB UI + Cloud Integration) 

🔬 This code contains the **extended implementation** developed as part of my **MSc Research Project (2025)** titled:
